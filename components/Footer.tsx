    ...
    <footer className="bg-black py-12 border-t border-white/10">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div>
                <button className="border border-white/20 text-white px-6 py-2 hover:bg-white hover:text-black transition-colors uppercase font-bold text-sm">
                    Back to Top
                </button>
            </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 text-center text-gray-600 text-xs">
            © 2026 MIDEA Innovation Club. All rights reserved.
        </div>
      </div>
    </footer>
  );
